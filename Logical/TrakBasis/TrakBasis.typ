...
TYPE
	...
	TrakCtrlStatusType : 	STRUCT  (*Status structure*)
		...
		Error : BOOL; (*The Assembly is in error*)
		ErrorInfo : TrakCtrlStatusErrorInfoType; (*Additional system error information*)
	...
	TrakCtrlStatusErrorInfoType : 	STRUCT  (*Track error related information*)
		ErrorID : DINT; (*The error id of any ocurred error*)
		ErrorText : STRING[255]; (*Error description*)
		ErrorInitiator : STRING[32]; (*Error initiator*)
	END_STRUCT;
